...
import org.ehcache.clustered.server.ClientSourceIdImpl;
...
public class EhcacheSyncMessageCodecTest {
  ...
  public void testMessageTrackerSyncEncodeDecode_messages() throws Exception {
    ClientSourceIdImpl id1 = new ClientSourceIdImpl(1);
    ClientSourceIdImpl id2 = new ClientSourceIdImpl(2);
    ...
    Map<ClientSourceId, Map<Long, EhcacheEntityResponse>> trackedMessages = decoded.getTrackedMessages();
    assertThat(trackedMessages).containsKeys(id1, id2);
    assertThat(trackedMessages.get(id1)).containsEntry(3L, r3);
    assertThat(trackedMessages.get(id1)).containsEntry(4L, r4);
    assertThat(trackedMessages.get(id2)).containsEntry(5L, r5);
  }
}
